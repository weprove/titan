<?php
// source: C:\xampp\htdocs\titan\app\modules\Admin/templates/@layout.latte

class Template7408e6dd74d7e12fa59322ca38761856 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('58aecc2401', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block css
//
if (!function_exists($_b->blocks['css'][] = '_lbea6d750fdf_css')) { function _lbea6d750fdf_css($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbe68ebda482_head')) { function _lbe68ebda482_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block _flashes
//
if (!function_exists($_b->blocks['_flashes'][] = '_lb7872130c1d__flashes')) { function _lb7872130c1d__flashes($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashes', FALSE)
?>					<div class="col-md-12">
...
// block scripts2
//
if (!function_exists($_b->blocks['scripts2'][] = '_lbcbce8c9e47_scripts2')) { function _lbcbce8c9e47_scripts2($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
<?php $_b->templates['58aecc2401']->renderChildTemplate("navbarHeader.latte", $template->getParameters()) ?>

<?php $_b->templates['58aecc2401']->renderChildTemplate("topBar.latte", $template->getParameters()) ?>
			
<?php $_b->templates['58aecc2401']->renderChildTemplate("sidebar.latte", $template->getParameters()) ?>
        </nav>

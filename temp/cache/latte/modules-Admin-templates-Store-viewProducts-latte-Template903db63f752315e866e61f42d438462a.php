...
?>	<div class="row">
		<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Store:addProduct", array($store_id)), ENT_COMPAT) ?>" class="btn btn-primary adding"> Add new product</a>	

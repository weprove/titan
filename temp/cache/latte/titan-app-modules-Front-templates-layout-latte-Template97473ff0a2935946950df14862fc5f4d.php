<?php
// source: C:\wamp\www\titan\titan\app\modules\Front/templates/@layout.latte

class Template97473ff0a2935946950df14862fc5f4d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b2e4adc0ef', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block css
//
if (!function_exists($_b->blocks['css'][] = '_lb29408ec4ee_css')) { function _lb29408ec4ee_css($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb49ddf08a27_scripts')) { function _lb49ddf08a27_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb55517f6004_head')) { function _lb55517f6004_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block _flashes
//
if (!function_exists($_b->blocks['_flashes'][] = '_lb0192c51ed4__flashes')) { function _lb0192c51ed4__flashes($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashes', FALSE)
...
// block scripts2
//
if (!function_exists($_b->blocks['scripts2'][] = '_lbb58a401f1e_scripts2')) { function _lbb58a401f1e_scripts2($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}

<?php
// source: C:\xampp\htdocs\titan\vendor\o5\grido\src/Grid.latte

class Templatefb0d4e6a0b7d6115872f51fd82050ef5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1b89ab8b66', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _grid
//
if (!function_exists($_b->blocks['_grid'][] = '_lbad81812c1e__grid')) { function _lbad81812c1e__grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('grid', FALSE)
...
// block outerFilter
//
if (!function_exists($_b->blocks['outerFilter'][] = '_lb36bf632615_outerFilter')) { function _lb36bf632615_outerFilter($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block table
//
if (!function_exists($_b->blocks['table'][] = '_lb4b4da439b0_table')) { function _lb4b4da439b0_table($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php if (is_string($column->getCustomRender()) && $column->getCustomRenderVariables()) { $_b->templates['1b89ab8b66']->renderChildTemplate($column->getCustomRender(), array_merge(array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column, ), $column->getCustomRenderVariables(), array()) + $template->getParameters()) ;} elseif (is_string($column->getCustomRender())) { $_b->templates['1b89ab8b66']->renderChildTemplate($column->getCustomRender(), array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column) + $template->getParameters()) ;} else { ?>
...
// block action
//
if (!function_exists($_b->blocks['action'][] = '_lb717551a574_action')) { function _lb717551a574_action($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block operations
//
if (!function_exists($_b->blocks['operations'][] = '_lb495506de44_operations')) { function _lb495506de44_operations($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block paginator
//
if (!function_exists($_b->blocks['paginator'][] = '_lbd8dcda6df5_paginator')) { function _lbd8dcda6df5_paginator($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block count
//
if (!function_exists($_b->blocks['count'][] = '_lbd9147c0e81_count')) { function _lbd9147c0e81_count($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>                <span class="count">

<?php
// source: C:\xampp\htdocs\titan\app\modules\Admin/templates/Order/default.latte

class Template5bd744b163f11616dcfbc6b6d04022f9 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c5c2bc7f78', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb68437469f5_scripts')) { function _lb68437469f5_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
			...
			$(".viewOrderDialogTrigger").click(function(e){
				...
				$.ajax({
					...
					success: function(data) {
					  ...
					  $("#orderDetailDialog").dialog({ 'width':600, 'height':250 });
					}
				});
			});
		});
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb8dc5038848_content')) { function _lb8dc5038848_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v

<?php
// source: C:\wamp\www\titan\titan\app\modules\Admin/templates/@layout.latte

class Template601e4cfe075e15e5e9229bb1efc5b38d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('13b7a04fca', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block css
//
if (!function_exists($_b->blocks['css'][] = '_lbfde893199e_css')) { function _lbfde893199e_css($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd4b532f714_scripts')) { function _lbd4b532f714_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['13b7a04fca']->renderChildTemplate('Grido.scripts.latte', $template->getParameters()) ?>
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb4243b68f77_head')) { function _lb4243b68f77_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block _flashes
//
if (!function_exists($_b->blocks['_flashes'][] = '_lbcd3b7827cd__flashes')) { function _lbcd3b7827cd__flashes($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashes', FALSE)
?>					<div class="col-md-12">
...
// block scripts2
//
if (!function_exists($_b->blocks['scripts2'][] = '_lb49c383039d_scripts2')) { function _lb49c383039d_scripts2($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
<?php $_b->templates['13b7a04fca']->renderChildTemplate("navbarHeader.latte", $template->getParameters()) ?>

<?php $_b->templates['13b7a04fca']->renderChildTemplate("topBar.latte", $template->getParameters()) ?>
			
<?php $_b->templates['13b7a04fca']->renderChildTemplate("sidebar.latte", $template->getParameters()) ?>
        </nav>

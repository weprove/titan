<?php
// source: C:\wamp\www\titan\titan\app\modules\Admin/templates/Sign/in.latte

class Template5354e3c8b8096d96d680686865be078c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7702623d46', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb70edc0862c_content')) { function _lb70edc0862c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<div class="row">

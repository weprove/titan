<?php
// source: C:\xampp\htdocs\titan\app\modules\Admin/templates/Store/viewStores.latte

class Template8b9f549feb55b8ad88d24443157d5449 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1529a13dd8', 'html')
;

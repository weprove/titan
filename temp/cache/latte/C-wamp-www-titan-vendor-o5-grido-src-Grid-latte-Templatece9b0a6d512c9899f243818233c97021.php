<?php
// source: C:\wamp\www\titan\vendor\o5\grido\src/Grid.latte

class Templatece9b0a6d512c9899f243818233c97021 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('12c5912bf9', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _grid
//
if (!function_exists($_b->blocks['_grid'][] = '_lb6fcdb5b029__grid')) { function _lb6fcdb5b029__grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('grid', FALSE)
...
// block outerFilter
//
if (!function_exists($_b->blocks['outerFilter'][] = '_lbff7fbaeef7_outerFilter')) { function _lbff7fbaeef7_outerFilter($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block table
//
if (!function_exists($_b->blocks['table'][] = '_lb95882ffb5a_table')) { function _lb95882ffb5a_table($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php if (is_string($column->getCustomRender()) && $column->getCustomRenderVariables()) { $_b->templates['12c5912bf9']->renderChildTemplate($column->getCustomRender(), array_merge(array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column, ), $column->getCustomRenderVariables(), array()) + $template->getParameters()) ;} elseif (is_string($column->getCustomRender())) { $_b->templates['12c5912bf9']->renderChildTemplate($column->getCustomRender(), array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column) + $template->getParameters()) ;} else { ?>
...
// block action
//
if (!function_exists($_b->blocks['action'][] = '_lb9822728574_action')) { function _lb9822728574_action($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block operations
//
if (!function_exists($_b->blocks['operations'][] = '_lbb4e02beacd_operations')) { function _lbb4e02beacd_operations($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block paginator
//
if (!function_exists($_b->blocks['paginator'][] = '_lb3b6449cf10_paginator')) { function _lb3b6449cf10_paginator($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block count
//
if (!function_exists($_b->blocks['count'][] = '_lbd5f0831215_count')) { function _lbd5f0831215_count($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>                <span class="count">

<?php
// source: C:\xampp\htdocs\titan\app\modules\Front/templates/@layout.latte

class Template4ca0cf5f7ce93cebef535e92f131d59b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('39f71c541e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block css
//
if (!function_exists($_b->blocks['css'][] = '_lbdfd72050b2_css')) { function _lbdfd72050b2_css($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbe2d42ca8f7_scripts')) { function _lbe2d42ca8f7_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb28147139a9_head')) { function _lb28147139a9_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block _flashes
//
if (!function_exists($_b->blocks['_flashes'][] = '_lbf893212d8c__flashes')) { function _lbf893212d8c__flashes($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashes', FALSE)
...
// block scripts2
//
if (!function_exists($_b->blocks['scripts2'][] = '_lbb48c4c753e_scripts2')) { function _lbb48c4c753e_scripts2($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
